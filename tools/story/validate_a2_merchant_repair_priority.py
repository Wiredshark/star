...
def test_state_only_dialogues_do_not_accept_objectiveless_missions():
    assert '\taccept\n' not in TEXT
...
def test_refusal_is_explicit_and_recovery_is_one_shot():
    assert '"A2 Merchant Repair Priority: refused" = 1' in TEXT
    assert 'not "A2 Merchant Repair Priority: recovery seen"' in TEXT
    assert '"A2 Merchant Repair Priority: refusal respected" = 1' in TEXT
